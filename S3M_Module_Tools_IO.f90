...
module S3M_Module_Tools_IO
    ...
    use S3M_Module_Tools_Generic,           only:   S3M_Tools_Generic_FindFileLength
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_CheckVar_NC(var_name_list, file_id, var_name_select)
        ...
        n = count(transfer(string_tmp, 'a', len(string_tmp)) == delimiter) + 1
        ...
        end subroutine S3M_Tools_IO_CheckVar_NC
#endif 
   !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Get1d_NC(sVarName, iFileID, a1dVar, sVarUnits, iX, &
                               bFatalError, iErr) 
    ...
    end subroutine S3M_Tools_IO_Get1d_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Get2d_NC(sVarName, iFileID, a2dVar, sVarUnits, iX, iY, &
                               bFatalError, iErr) 
    ...
    end subroutine S3M_Tools_IO_Get2d_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Get3d_NC(sVarName, iFileID, a3dVar, sVarUnits, iT, iX, iY, &
                                     bFatalError, iErr) 
    ...
    end subroutine S3M_Tools_IO_Get3d_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_PutTime_DBL_NC(iFileID, iID_DimTime, &
    ...
    end subroutine S3M_Tools_IO_PutTime_DBL_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_PutTime_STR_NC(iFileID, iID_DimTime, &
                               sVarName, sVarNameLong, sVarDescription, &
                               sVarUnits, &
                               sVarCoords, &
                               iVarTime, sVarValue) 
    ...
    end subroutine S3M_Tools_IO_PutTime_STR_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Put1d_NC(iFileID, iID_DimX, &
                               sVarName, sVarNameLong, sVarDescription, &
                               sVarUnits, &
    ...
    end subroutine S3M_Tools_IO_Put1d_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Put2d_NC(iFileID, iID_DimX, iID_DimY, &
                               sVarName, sVarNameLong, sVarDescription, &
                               sVarUnits, &
                               sVarCoords, sVarGridMap, &
                               dVarMissingValue, &
        ...
        ! sVarName = 'SWE'
        ! sVarNameLong = 'swe'
        ! sVarDescription = 'snow water equivalent'
        ! sVarUnits = 'mm'
        ! sVarCoords = 'x y z'
    ...
    end subroutine S3M_Tools_IO_Put2d_NC
#endif
    !------------------------------------------------------------------------------------
...
#ifdef LIB_NC
    subroutine S3M_Tools_IO_Put3d_NC(iFileID, iID_DimX, iID_DimY, iID_DimT, &
                                     sVarName, sVarNameLong, sVarDescription, &
                                     sVarUnits, &
                                     sVarCoords, sVarGridMap, &
                                     dVarMissingValue, &
    ...
    end subroutine S3M_Tools_IO_Put3d_NC
#endif
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to get 1d variable ASCII (1 columns)
    subroutine S3M_Tools_IO_Get1d_ASCII(sFileName, a1dVar, iX, &
        ...
        elseif ( bFileExist ) then
            ...
            call S3M_Tools_Generic_FindFileLength(1, iFileLength, iSkipRows_Set)
    ...
    end subroutine S3M_Tools_IO_Get1d_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------------
    ! Subroutine to get Nd variable ASCII (N columns)
    subroutine S3M_Tools_IO_GetNd_ASCII(sFileName, a2dVar, iX, iY, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_GetNd_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------------
    ! Subroutine to get 2d variable ASCII (2 columns)
    subroutine S3M_Tools_IO_Get2d_ASCII(sFileName, a1sVar, a1dVar, iX, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Get2d_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to get ArcGrid variable ASCII
    subroutine S3M_Tools_IO_GetArcGrid_ASCII(sFileName, a2dVar, iX, iY, &
                               bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_GetArcGrid_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to put 1d variable ASCII
    subroutine S3M_Tools_IO_Put1d_ASCII(sFileName, a1dVar, iX, bFatalError, iErr, sFMT)
    ...
    end subroutine S3M_Tools_IO_Put1d_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to put 2d variable ASCII
    subroutine S3M_Tools_IO_Put2d_ASCII(sFileName, a2dVar, iX, iY, &
    ...
    end subroutine S3M_Tools_IO_Put2d_ASCII
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to write time-series in ASCII format
    subroutine S3M_Tools_IO_WriteTS_ASCII(sFileName, sTimeStep, a1dVar, iX, iFileUnit, bFileUnit, bFatalError, sFileFormat)
    ...
    end subroutine S3M_Tools_IO_WriteTS_ASCII
    !------------------------------------------------------------------------------------
        
    !------------------------------------------------------------------------------------
    ! Subroutine to get 2d variable binary in INTeger format
    subroutine S3M_Tools_IO_Get2d_Binary_INT(sFileName, a2dVar, iX, iY, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Get2d_Binary_INT
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to get 2d variable binary in DouBLe format
    subroutine S3M_Tools_IO_Get2d_Binary_DBL(sFileName, a2dVar, iX, iY, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Get2d_Binary_DBL
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to get 3d variable binary in INTeger format
    subroutine S3M_Tools_IO_Get3d_Binary_INT(sFileName, a3dVar, iX, iY, iT, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Get3d_Binary_INT
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to get 3d variable binary in DouBLe format
    subroutine S3M_Tools_IO_Get3d_Binary_DBL(sFileName, a3dVar, iX, iY, iT, iVarScale, bFatalError, iErr)
        ...
        elseif ( bFileExist ) then
            ...
            if (iRet == 0) then 
                ...
                do iK = 1,iT
                    do iJ = 1,iY
                       read(1,rec=iJ)(a3dVar(iX - iI + 1, iJ, iK),iI = 1,iX)
                    enddo
                enddo
                close(1)

                a3dVar = a3dVar/real(iVarScale)
    ...
    end subroutine S3M_Tools_IO_Get3d_Binary_DBL
    !------------------------------------------------------------------------------------
        
    !------------------------------------------------------------------------------------
    ! Subroutine to put 2d variable binary in INTeger format
    subroutine S3M_Tools_IO_Put2d_Binary_INT(sFileName, a2dVar, iX, iY, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Put2d_Binary_INT
    !------------------------------------------------------------------------------------

    !------------------------------------------------------------------------------------
    ! Subroutine to put 2d variable binary in DouBLe format
    subroutine S3M_Tools_IO_Put2d_Binary_DBL(sFileName, a2dVar, iX, iY, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Put2d_Binary_DBL
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to put 3d variable binary in INTeger format
    subroutine S3M_Tools_IO_Put3d_Binary_INT(sFileName, a3dVar, iX, iY, iT, iVarScale, bFatalError, iErr)
    ...
    end subroutine S3M_Tools_IO_Put3d_Binary_INT
    !------------------------------------------------------------------------------------
    
    !------------------------------------------------------------------------------------
    ! Subroutine to put 3d variable binary binary in DouBLe format
    subroutine S3M_Tools_IO_Put3d_Binary_DBL(sFileName, a3dVar, iX, iY, iT, iVarScale, bFatalError, iErr)
        ...
        elseif ( bFileExist ) then
            ...
            if (iRet == 0) then 
                ...
                do iK = 1,iT
                    do iJ = 1,iY
                        write(20,rec=iJ)(a3dVar(iX - iI + 1, iJ, iK),iI = 1,iX)
                    enddo
                enddo
                ! Close file
                close(20)
    ...
    end subroutine S3M_Tools_IO_Put3d_Binary_DBL
    !------------------------------------------------------------------------------------
...
end module S3M_Module_Tools_IO
!------------------------------------------------------------------------------------
